---
title: "Sierra: detecting differential transcript usage in 3'-enriched scRNA-seq data"
author: 
  - name: Ralph Patrick
...
For Seurat, we require a minimum of version 3 for compatibility with Sierra. To install Seurat please see instructions at the [Seurat home page](https://satijalab.org/seurat/). 
...
Create peak-level Seurat object. Since we're using a reduced matrix need to set min.cells and min.peaks to 0 or else everything gets filtered out.
