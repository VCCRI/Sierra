...
### Read in the counts
peak.counts = readMEX(mm.file = "TIP_vignette_peak_data_MEX/matrix.mtx",
                      barcodes.file = "TIP_vignette_peak_data_MEX/barcodes.tsv",
                      genes.file = "TIP_vignette_peak_data_MEX/sitenames.tsv")
